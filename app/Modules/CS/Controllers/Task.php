...
namespace App\Modules\CS\Controllers;

use App\Controllers\BaseController;
use App\Modules\CS\Models\RuanganModel;
use App\Modules\CS\Models\TaskModel;
use App\Modules\CS\Models\WaktuModel;
...
class Task extends BaseController
{
    public function index()
    {
        ...
        $builder->groupStart()
            ->groupStart()
            ->like('tb_lokasi.nama_lokasi', 'GKP')
            ->orLike('tb_lokasi.nama_lokasi', 'GPT')
            ->orLike('tb_lokasi.nama_lokasi', 'GKL')
            ->groupEnd()
            ->notLike('tb_lokasi.nama_lokasi', 'Zona Outdoor - Zona')
            ->groupEnd();
        ...
        return view('App\Modules\CS\Views\index', $data);
    }
    ...
    public function checklist($uuid_ruangan)
    {
        ...
        if (!$ruangan) {
            return view('App\Modules\CS\Views\Checklist\notfound', ['uuid_ruangan' => $uuid_ruangan]);
        }
        ...
        return view('App\Modules\CS\Views\Checklist\checklist_task', [
            'ruangan' => $ruangan,
    ...
    public function checklist_task($uuid_ruangan)
    {
        ...
        return view('App\Modules\CS\Views\Checklist\rincian_checklist_task', [
            'ruangan' => $ruangan,
            'tasks'   => $tasks,
    ...
    {
        return view('App\Modules\CS\Views\Checklist\checklist_selesai');
    }
}
