...
namespace App\Modules\Takmir\Controllers;

use App\Controllers\BaseController;
use App\Modules\Takmir\Models\RuanganModel;
use App\Modules\Takmir\Models\TaskModel;
use App\Modules\Takmir\Models\WaktuModel;
...
class Task extends BaseController
{
    public function index()
    {
        ...
        $builder->like('tb_lokasi.nama_lokasi', 'Masjid An-Nur');
        ...
        return view('App\Modules\Takmir\Views\index', $data);
    }
    ...
    public function checklist($uuid_ruangan)
    {
        ...
        if (!$ruangan) {
            return view('App\Modules\Takmir\Views\Checklist\notfound', ['uuid_ruangan' => $uuid_ruangan]);
        }
        ...
        return view('App\Modules\Takmir\Views\Checklist\checklist_task', [
            'ruangan' => $ruangan,
    ...
    public function checklist_task($uuid_ruangan)
    {
        ...
        return view('App\Modules\Takmir\Views\Checklist\rincian_checklist_task', [
            'ruangan' => $ruangan,
            'tasks'   => $tasks,
    ...
    {
        return view('App\Modules\Takmir\Views\Checklist\checklist_selesai');
    }
}
