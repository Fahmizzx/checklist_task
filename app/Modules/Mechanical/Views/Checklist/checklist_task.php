                                ...
                                <div class="mb-5">
                                    <div class="card shadow-sm">
                                        <div class="card-body px-4 py-3">
                                            <h4 class="fw-bold text-dark mb-3">Checklist Harian ME PT. INTI (Persero)</h4>
                                            <p class="text-gray-700 mb-2">
                                                <strong>Peraturan Checklist Harian Ruangan:</strong><br>
                                                1. Petugas Checklist adalah Mechanical Electrical (ME). Pengisian dengan cara dichecklist satu per satu sesuai dengan pertanyaan secara berurutan untuk semua Ruangan Kerja.<br>
