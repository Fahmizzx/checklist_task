...
use App\Modules\Mechanical\Models\RuanganModel;
use App\Modules\Mechanical\Models\TaskModel;
use App\Modules\Mechanical\Models\WaktuModel;
...
class Task extends BaseController
{
    public function index()
    {
        ...
        $builder->like('tb_lokasi.nama_lokasi', 'ME');
        ...
        return view('App\Modules\Mechanical\Views\index', $data);
    }
    ...
    public function checklist($uuid_ruangan)
    {
        ...
        if (!$ruangan) {
            return view('App\Modules\Mechanical\Views\Checklist\notfound', ['uuid_ruangan' => $uuid_ruangan]);
        }
        ...
        return view('App\Modules\Mechanical\Views\Checklist\checklist_task', [
            'ruangan' => $ruangan,
    ...
    public function checklist_task($uuid_ruangan)
    {
        ...
        return view('App\Modules\Mechanical\Views\Checklist\rincian_checklist_task', [
            'ruangan' => $ruangan,
            'tasks'   => $tasks,
    ...
    {
        return view('App\Modules\Mechanical\Views\Checklist\checklist_selesai');
    }
}
